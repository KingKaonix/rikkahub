...
import me.rerere.rikkahub.ui.theme.presets.DenseProThemePreset
import me.rerere.rikkahub.ui.theme.presets.GlassmorphismThemePreset
import me.rerere.rikkahub.ui.theme.presets.OceanThemePreset
import me.rerere.rikkahub.ui.theme.presets.PastelThemePreset
import me.rerere.rikkahub.ui.theme.presets.SakuraThemePreset
import me.rerere.rikkahub.ui.theme.presets.Spatial3DThemePreset
...
val PresetThemes by lazy {
    listOf(
        ...
        AutumnThemePreset,
        BlackThemePreset,
        GlassmorphismThemePreset,
        CyberpunkThemePreset,
        PastelThemePreset,
        Spatial3DThemePreset,
        DenseProThemePreset,
    )
}
